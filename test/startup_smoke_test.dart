...
void main() {
  group('Startup Isar provider wiring (smoke test)', () {
    test('isarProvider throws UnimplementedError when left un-overridden', () {
    ...
    test('a ProviderContainer configured the same way main() configures it can '
        'open Isar and save/fetch a game result end-to-end', () async {
